          ...
          <div className="container mx-auto px-8 py-16 grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                Buy NFT lottery tickets where numbers are unveiled
                progressively. Trade, hold, or sell based on partial number
                matches!
              </p>
          ...
          <div className="container mx-auto px-8 py-16">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                A revolutionary lottery concept where anticipation builds with
                each number reveal
              </p>
            </div>
